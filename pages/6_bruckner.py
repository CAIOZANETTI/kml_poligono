...
if not faixas:
    st.warning("Nenhuma faixa calculada. Verifique o poligono e parametros.")
    st.stop()
...
# ─── Volumes por faixa ───
section_header("volumes por faixa")
...
# ─── Perfil da faixa selecionada ───
section_header("perfil da faixa")
...
# ─── Zonas de transporte ───
section_header("zonas de transporte")
